...
# 7단계: 설치 확인 및 재시작 (권한 적용)
echo "7. 설치 확인 및 재시작 중..."
sleep 30
...
echo "재시작 완료, Pod가 안정화될 때까지 대기 중..."
sleep 45
...
echo "⚠️  주의사항:"
echo "- 기존 Role이 있는 경우 Trust Policy가 자동으로 현재 클러스터 OIDC로 업데이트됩니다"
echo "- Ingress 리소스 생성 후 ADDRESS 필드에 ALB 주소가 나타나는지 확인하세요"